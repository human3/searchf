...
KEYS_TO_COMMAND = {
    ...
    ord('X'):              enums.Command.TOGGLE_NEGATE,
    ...
    ord('w'):              enums.Command.GO_UP,
    ord('s'):              enums.Command.GO_DOWN,
    ord('a'):              enums.Command.GO_LEFT,
    ord('d'):              enums.Command.GO_RIGHT,
    ord('W'):              enums.Command.GO_PPAGE,
    ord('S'):              enums.Command.GO_NPAGE,
    ord('A'):              enums.Command.GO_SLEFT,
    ord('D'):              enums.Command.GO_SRIGHT,
    ...
    curses.KEY_F1:         enums.Command.SHOW_HELP,
    ...
    # Undocummented mapping (for testing)
    ord('{'):              enums.Command.ROTATE_FILTERS_UP,
...
ESCAPED_TO_COMMAND = {
    ...
    's':                   enums.Command.ROTATE_FILTERS_DOWN,
    ...
    'a':                   enums.Command.ROTATE_KEYWORDS_LEFT,
    chr(curses.KEY_LEFT):  enums.Command.ROTATE_KEYWORDS_LEFT,
    CTRL + LEFT:           enums.Command.ROTATE_KEYWORDS_LEFT,
    CTRL_SHIFT + LEFT:     enums.Command.ROTATE_KEYWORDS_LEFT,
    ALT + LEFT:            enums.Command.ROTATE_KEYWORDS_LEFT,
    'd':                   enums.Command.ROTATE_KEYWORDS_RIGHT,
    chr(curses.KEY_RIGHT): enums.Command.ROTATE_KEYWORDS_RIGHT,
    CTRL + RIGHT:          enums.Command.ROTATE_KEYWORDS_RIGHT,
    CTRL_SHIFT + RIGHT:    enums.Command.ROTATE_KEYWORDS_RIGHT,
    ALT + RIGHT:           enums.Command.ROTATE_KEYWORDS_RIGHT,
